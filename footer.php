<?php if(is_home()): ?>
echo do_shortcode( '[tiled_blog_roll]' );
<?php endif; ?>
<?php if(is_page( '11452' ))  { echo do_shortcode( '[tiled_blog_roll]' ); }  ?> 



<?php 
global $peLongFormImage; global $peLongFormCaption; 
global $essayType; 
...
print "\n\n\n\n\n\n\n<div class=\"titleEnder_container\" style=\"background-size: cover;  background-image: url('".$peLongFormImage."'); no-repeat center center fixed; width:100%; height:600px;\" onmouseout=\"document.getElementById('titleEnderCaption').style.display = 'none'\";  onmouseover=\"document.getElementById('titleEnderCaption').style.display = 'block'\"; >";
print "</div>\n\n\n\n\n\n\n";
print "\n\n\n\n\n\n\n<div class=\"titleEnderCaption\"   id=\"titleEnderCaption\" >".$peLongFormCaption."</div>\n\n\n\n\n\n\n";
}
?> 
