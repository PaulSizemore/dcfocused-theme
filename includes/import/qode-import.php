...
class Qode_Import {
    ...
    function qode_generate_import_page() {
        ...
        <div id="qode-metaboxes-general" class="wrap qodef-page qodef-page-info">
            <h2 class="qodef-page-title"><?php _e('Visually-Dynamic — One-Click Import', 'qode') ?></h2>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            ...
                                            <select name="import_example" id="import_example" class="form-control qodef-form-element">
												<option value="stockholm1">Visually-Dynamic 1 - Anders</option>
												<option value="stockholm2">Visually-Dynamic 2 - Bjorn</option>
												<option value="stockholm3">Visually-Dynamic 3 - Claes</option>
												<option value="stockholm4">Visually-Dynamic 4 - Daniel</option>
												<option value="stockholm5">Visually-Dynamic 5 - Erland</option>
												<option value="stockholm6">Visually-Dynamic 6 - Fredrik</option>
												<option value="stockholm7">Visually-Dynamic 7 - Gustav</option>
												<option value="stockholm8">Visually-Dynamic 8 - Hugo</option>
												<option value="stockholm9">Visually-Dynamic 9 - Ingmar</option>
												<option value="stockholm10">Visually-Dynamic 10 - Jonas</option>
												<option value="stockholm11">Visually-Dynamic 11 - Kaleb</option>
												<option value="stockholm12">Visually-Dynamic 12 - Lars</option>
												<option value="stockholm13">Visually-Dynamic 13 - Magnus</option>
												<option value="stockholm14">Visually-Dynamic 14 - Noel</option>
												<option value="stockholm15">Visually-Dynamic 15 - Oskar</option>
												<option value="stockholm16">Visually-Dynamic 16 - Petter</option>
												<option value="stockholm17">Visually-Dynamic 17 - Roland</option>
												<option value="stockholm18">Visually-Dynamic 18 - Sigfrid</option>
												<option value="stockholm19">Visually-Dynamic 19 - Tomas</option>
												<option value="stockholm20">Visually-Dynamic 20 - Viggo</option>
