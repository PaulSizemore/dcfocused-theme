...
if(!function_exists('qode_hook_twitter_request_ajax')) {
	 ...
	 *
	 * @see QodeVisually-DynamicTwitterApi::obtainRequestToken()
	 */
	function qode_hook_twitter_request_ajax() {
		QodeVisually-DynamicTwitterApi::getInstance()->obtainRequestToken();
	}
...
if(!function_exists('qode_hook_instagram_disconnect_ajax')) {
	 ...
	 *
	 * @see QodeVisually-DynamicInstagramApi::obtainRequestToken()
	 */
	function qode_hook_instagram_disconnect_ajax() {
		QodeVisually-DynamicInstagramApi::getInstance()->disconnectUser();
	}
